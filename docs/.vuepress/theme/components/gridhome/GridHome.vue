<template>
  <div class="grid-home-container">
    ...
    <div class="head-social">
      <a href="https://github.com/TenOne506/" target="_blank" class="head-social-btn">
      ...
      <a href="w13852770506@163.com" target="_blank" class="head-social-btn">
    ...
    <div class="about-me">
      <div class="card-content grid-row-3-2">
        ...
        <AboutMeText>
          <template #motto>
            <slot name="motto">
              <p class="about-me-card-title-normal">How I Work</p>
              <p class="about-me-card-text-big">Thrives in ambiguity</p>
              <p class="about-me-card-text-big">Challenges status quo</p>
            </slot>
          </template>
        </AboutMeText>
      </div>
      ...
      <div class="card-content grid-row-1-1">
        <AboutMeText>
          <template #motto>
  <slot name="motto">
    <p class="about-me-card-title-normal">Tenet</p>
    <p class="about-me-card-text-big about-me-card-text-soft">谦逊</p>
    <p class="about-me-card-text-big" style="color: #4f46e5;">尊重</p>   <!-- Indigo-600 -->
    <p class="about-me-card-text-big" style="color: #dc2626;">信任</p>   <!-- Rose-600 -->
  </slot>
</template>
        </AboutMeText>
        <AboutMeCharacter />
